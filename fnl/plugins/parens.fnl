   ...
   {:dependencies ["julienvincent/nvim-paredit-fennel"]
    ...
    :config (fn []
              (let [paredit (require :nvim-paredit)
                ...
                (paredit.setup
                  {:keys
                   {:<localleader>sb [paredit.api.slurp_backwards "Slurp backwards"]
                    :<localleader>bb [paredit.api.barf_backwards "Barf backwards"]
                    :<localleader>bf [paredit.api.barf_forwards "Barf forwards"]
                    :<localleader>sf [paredit.api.slurp_forwards "Slurp forwards"]
